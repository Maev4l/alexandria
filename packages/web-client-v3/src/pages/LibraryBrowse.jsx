...
const SkeletonRow = () => (
  <div className="flex gap-4 border-b border-ink p-4" aria-hidden="true">
    {/* Ruled and NOT filled: the empty frame carries the rule and nothing else, and this
        ...
        stands in for a line of text, not for artwork, and a text placeholder is filled while
        an artwork placeholder is only ruled. ItemDetail's skeleton already draws this
        distinction; the two screens now agree. */}
