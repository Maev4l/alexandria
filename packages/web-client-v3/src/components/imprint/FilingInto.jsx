...
// screen that flashes past does not have. Its absence is what says "standalone": no
// `collectionId`, no name, no mark, on every one of these four screens alike — never a gate on
// what the screen can otherwise do.
//
// The caps belong to the LABEL only — the collection name is content the reader authored, and
// content titles are never uppercased. `caps` on the outer <p> would otherwise
