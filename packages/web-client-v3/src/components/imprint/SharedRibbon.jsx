...
// item-detail hero (the Detail Marks column). Words first: colour alone would not be
// readable state.
//
// `--shared` measures ~3:1 on the black cover — sound for an edge, far short of
...
//
// Weight is intentionally not set here: the `caps` utility states weight only at
